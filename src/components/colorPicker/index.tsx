...
const colors = [
  ...
  '#00ff00', '#00ff24', '#00ff49', '#00ff6d', '#00ff92', '#00ffb6', '#00ffdb', '#00ffff',
  '#00e3ff', '#00c6ff', '#00aaff', '#008eff', '#0071ff', '#0055ff', '#0038ff', '#001cff',
  '#0000ff', '#2000ff', '#4000ff', '#6000ff', '#8000ff', '#a000ff', '#c000ff', '#e000ff',
  '#ff00ff', '#ff20ff', '#ff40ff', '#ff60ff', '#ff80ff', '#ffa0ff', '#ffc0ff', '#ffe0ff',
  '#ffffff', '#ffe0e0', '#ffc0c0', '#ffa0a0', '#ff8080', '#ff6060', '#ff4040', '#ff2020',
  '#000000', '#202020', '#404040', '#606060', '#808080', '#a0a0a0', '#c0c0c0', '#e0e0e0'
]

const ColorPicker: FC<ColorPickerProps> = ({ visible, onClose, onSelect, currentColor }) => {
